(function() {
  ...
  enyo.kind({
    ...
    tap: function(inSender, inEvent) {
      var me;
      me = this;
      _.each(me.parent.parent.parent.parent.parent.$.order1.$.lines.$, function(elem) {
        return elem.applyStyle('background-color', 'white');
      });
      _.each(me.parent.parent.parent.parent.parent.$.order2.$.lines.$, function(elem) {
        return elem.applyStyle('background-color', 'white');
      });
      this.applyStyle('background-color', 'green');
      this.$.product.addClass('selected-line');
      return me.parent.parent.parent.parent.parent.setSelectedLine(me.model);
    }
  });
